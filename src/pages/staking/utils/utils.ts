...
export interface Validator {
  ...
  export async function getStakingApr() {
    const urlInflation = CantoMainnet.cosmosAPIEndpoint + "/canto/inflation/v1/epoch_mint_provision";
    const urlStake = CantoMainnet.cosmosAPIEndpoint + "/cosmos/staking/v1beta1/pool";
